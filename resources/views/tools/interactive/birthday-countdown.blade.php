                    ...
                    <div class="col-md-7">
                        <div class="p-4 rounded-4 bg-light border h-100">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" id="v-date" class="form-control border-0 bg-white shadow-sm rounded-4 p-4 fw-bold h4 mb-0" value="{{ date('Y-m-d', strtotime('+30 days')) }}">
                            </div>
                            <div class="row g-2">
                                <div class="col-6">
                                    <button class="btn btn-white w-100 rounded-pill py-2 small fw-bold shadow-sm quick-load" data-v="{{ date('Y-m-d', strtotime('+7 days')) }}">Next Week</button>
                                </div>
                                <div class="col-6">
                                    <button class="btn btn-white w-100 rounded-pill py-2 small fw-bold shadow-sm quick-load" data-v="{{ date('Y-m-d', strtotime('+30 days')) }}">Next Month</button>
                                </div>
                            </div>
                        </div>
                    </div>
