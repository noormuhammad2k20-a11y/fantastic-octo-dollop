            ...
            <div class="calculator-body">
                <div class="row g-4">
                    ...
                    <div id="ga-lmp-box" class="col-md-12">
                        ...
                        <input type="date" id="ga-lmp-date" class="form-control form-control-lg rounded-3" value="{{ date('Y-m-d', strtotime('-4 weeks')) }}">
                    </div>
                    ...
                    <div id="ga-scan-box" class="col-md-12 d-none">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="date" id="ga-scan-date" class="form-control form-control-lg rounded-3" value="{{ date('Y-m-d') }}">
                            </div>
                            <div class="col-md-3">
