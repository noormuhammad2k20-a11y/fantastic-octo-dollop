            ...
            <div class="calculator-body">
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mt-2">
                            <small class="text-muted">Not sure? Use the <a href="{{ url('/bmr-calculator-pro') }}" class="text-decoration-none text-primary fw-bold">BMR Pro</a> tool first.</small>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    {{-- Row 2: Macros (Optional calculation factor) --}}
                    <div class="col-md-6">
