                ...
                <div class="table-responsive">
                    <table class="table table-bordered text-center align-middle mb-0" id="score-table" style="border-radius: 12px; overflow: hidden; border-style: hidden; box-shadow: 0 0 0 1px #e2e8f0;">
                        <thead class="bg-slate-50">
                            <tr>
                                @for($i=1; $i<=9; $i++) <th style="width: 9%;">F{{$i}}</th> @endfor
                            ...
                            <tr>
                                ...
                                <td class="p-1">
                                    <div class="d-flex gap-1">
                                        <input type="text" class="form-control form-control-sm text-center fw-bold ball-input" data-frame="{{$i}}" data-ball="1" maxlength="1" placeholder="-">
                                        <input type="text" class="form-control form-control-sm text-center fw-bold ball-input" data-frame="{{$i}}" data-ball="2" maxlength="1" placeholder="-">
                                    </div>
                                    <div class="mt-2 small text-muted frame-total" id="frame-{{$i}}-total">0</div>
                                </td>
                                @endfor
                                <td class="p-1">
                                    <div class="d-flex gap-1">
