            ...
            <div class="calculator-body">
                <div class="row g-4 justify-content-center text-center">
                    <div class="col-md-7">
                        ...
                        <input type="date" id="pc-lmp-date" class="form-control form-control-lg rounded-pill px-4 text-center border-2 border-primary-subtle" value="{{ date('Y-m-d', strtotime('-10 weeks')) }}">
