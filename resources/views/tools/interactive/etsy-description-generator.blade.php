...
btn.addEventListener('click',function(){
    ...
    fetch('{{ route("ai.generate",["type"=>"etsy-description"]) }}',{method:'POST',headers:{'Content-Type':'application/json','X-CSRF-TOKEN':'{{ csrf_token() }}'},body:JSON.stringify({productName:productName.value,category:category.value,keywords:keywords.value})})
