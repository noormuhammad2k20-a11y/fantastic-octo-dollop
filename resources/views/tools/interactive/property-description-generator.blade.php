...
btn.addEventListener('click',function(){
    ...
    fetch('{{ route("ai.generate",["type"=>"property-description"]) }}',{method:'POST',headers:{'Content-Type':'application/json','X-CSRF-TOKEN':'{{ csrf_token() }}'},body:JSON.stringify({propertyType:propertyType.value,bedrooms:bedrooms.value,features:features.value})})
