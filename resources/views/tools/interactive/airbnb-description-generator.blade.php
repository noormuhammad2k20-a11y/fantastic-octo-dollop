...
btn.addEventListener('click',function(){
    ...
    fetch('{{ route("ai.generate",["type"=>"airbnb-description"]) }}',{method:'POST',headers:{'Content-Type':'application/json','X-CSRF-TOKEN':'{{ csrf_token() }}'},body:JSON.stringify({propertyType:propertyType.value,location:location.value,amenities:amenities.value})})
