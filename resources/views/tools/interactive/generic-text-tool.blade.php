<div class="interactive-card">
    <div class="interactive-header">
        <h4><i class="{{ $tool['icon'] ?? 'fas fa-edit' }}"></i> {{ $tool['h1'] }} Workspace</h4>
    ...
    <div class="interactive-body">
        <div class="row g-4">
            ...
            <div class="col-lg-6">
                ...
                <textarea id="generic-input" class="form-control" rows="12" placeholder="Paste your {{ strtolower($tool['h1']) }} data here..."></textarea>
            </div>
        ...
        <div class="action-bar mt-4 text-center">
            <button class="btn btn-lg btn-accent px-5 py-3 fw-bold shadow-sm" id="btn-process-generic" style="min-width: 280px; max-width: 100%;">
                <i class="fas fa-magic me-2"></i> Process {{ $tool['h1'] }}
            </button>
        </div>
    </div>
</div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        btnProcess.addEventListener('click', function() {
            ...
            setTimeout(() => {
                ...
                btnProcess.innerHTML = '<i class="fas fa-magic me-2"></i> Process {{ $tool["h1"] }}';
