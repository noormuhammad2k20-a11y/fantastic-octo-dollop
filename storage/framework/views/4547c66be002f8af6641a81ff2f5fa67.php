        ...
        <div class="card-body-v2 p-4">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <label class="form-label small fw-bold text-secondary text-uppercase mb-2">Length (l)</label>
                    <input type="number" id="in-l" class="form-control form-control-lg rounded-3" value="0" step="any" min="0">
                </div>
                <div class="col-md-6 col-lg-4">
                    <label class="form-label small fw-bold text-secondary text-uppercase mb-2">Width (w)</label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculate() {
      ...
      document.getElementById('out-area').textContent = area.toFixed(prec);
        ...
        // Apply units
        const outputConfigs = [{"id":"out-area","label":"Total Surface Area (A)","suffixUnit":"sq units"}];
    ...
    btnCopyRes.addEventListener('click', function() {
        const txt = `Total Surface Area (A): ${document.getElementById('out-area').textContent} ${document.getElementById('out-area-unit').textContent}`;
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\total-surface-area-calculator.blade.php ENDPATH**/ ?>