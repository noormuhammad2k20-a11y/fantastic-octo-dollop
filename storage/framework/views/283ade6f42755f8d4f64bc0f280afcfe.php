<div class="row g-4 sha224-rebuilt">
    <div class="col-lg-12">
    ...
    <div class="col-lg-12">
        <div class="output-card-themed" style="--tool-hue:40;--tool-color:#f59e0b;--tool-bg:rgba(245,158,11,.04);">
            <div class="output-hero"><span class="output-hero-label">SHA-224 HASH DIGEST</span><div class="output-hero-value hash-output-box" id="hash-result" style="font-size:1.05rem;font-family:'Courier New',monospace;word-break:break-all;overflow-wrap:break-word;">—</div></div>
            <div class="row g-3 mt-3">
                <div class="col-6 col-md-3"><div class="stat-card"><span class="stat-card-label">ALGORITHM</span><span class="stat-card-value" style="font-size:1rem">SHA-224</span></div></div>
...
document.addEventListener('DOMContentLoaded',function(){
    ...
    function hexToBase64(hex){const bytes=hex.match(/.{2}/g).map(b=>parseInt(b,16));return btoa(String.fromCharCode(...bytes));}
    function generate(){
        ...
        for(let i=0;i<iterations;i++){result=sha256.sha224(current);current=result;}
...
<style>.sha224-rebuilt .calculator-card{background:#fff;border:1px solid #e5e7eb;border-radius:20px;padding:2rem;box-shadow:0 4px 24px rgba(0,0,0,.04)}.sha224-rebuilt .calculator-header{display:flex;align-items:center;gap:1.25rem;margin-bottom:2rem}.sha224-rebuilt .calculator-header h4{margin:0;font-weight:800;color:#1e293b;font-size:1.25rem}.sha224-rebuilt .calculator-header p{margin:0;font-size:.85rem;color:#64748b}.sha224-rebuilt .tool-icon-circle{width:56px;height:56px;border-radius:14px;display:flex;align-items:center;justify-content:center;font-size:1.4rem;flex-shrink:0}.sha224-rebuilt .form-label-custom{font-size:.8rem;font-weight:700;color:#475569;text-transform:uppercase;letter-spacing:.5px;margin-bottom:.4rem;display:block}.hash-output-box{max-width:100%;overflow-x:auto;padding:.5rem 0}</style>
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\sha224-hash-generator.blade.php ENDPATH**/ ?>