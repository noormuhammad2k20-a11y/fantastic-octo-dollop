            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 text-center">
                    <div class="p-4 rounded-4 bg-light border h-100 d-flex flex-column justify-content-center">
                        <p class="text-muted fw-bold text-uppercase small letter-spacing-1 mb-2">Area (A)</p>
                ...
                <div class="col-md-6 text-center">
                    <div class="p-4 rounded-4 bg-light border h-100 d-flex flex-column justify-content-center">
                        <p class="text-muted fw-bold text-uppercase small letter-spacing-1 mb-2">Circumference (C)</p>
                        <div class="display-5 fw-bold text-dark mb-0 text-break overflow-x-auto" id="out-circ">0.00</div>
                        <div class="mt-2 text-muted fw-bold unit-display" id="out-circ-unit"></div>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculate() {
      ...
      document.getElementById('out-circ').textContent = circ.toFixed(prec);
    

        // Apply units
        const outputConfigs = [{"id":"out-area","label":"Area (A)","suffixUnit":"sq units"},{"id":"out-circ","label":"Circumference (C)","suffixUnit":"units"}];
    ...
    btnCopyForm.addEventListener('click', function() {
        const formula = `$$A = \pi r^2$$, $$C = 2\pi r$$`;
    ...
    btnCopyRes.addEventListener('click', function() {
        const txt = `Area (A): ${document.getElementById('out-area').textContent} ${document.getElementById('out-area-unit').textContent} | Circumference (C): ${document.getElementById('out-circ').textContent} ${document.getElementById('out-circ-unit').textContent}`;
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views/tools/interactive/area-of-a-circle-calculator.blade.php ENDPATH**/ ?>