<div class="interactive-tool-grid landscaping-cost-calculator">
    <div class="calculator-card">
        <div class="calculator-header">
            <div class="tool-icon-circle"><i class="fas fa-grass"></i></div>
            <div><h4>Landscaping Calculator</h4><p>Accurate Estimation Tool</p></div>
        </div>
        <div class="calculator-body">            <div class="form-group-custom mb-3"><label class="form-label-custom">Area (SQFT)</label><input type="number" id="ls" class="form-control-custom" placeholder="e.g. 5000"></div>
</div>
    </div>
    <div class="result-panel">
        <div class="result-card-v2">
            ...
            <div class="result-sub-stats">                <div class="stat-item border-end pe-3"><span class="stat-label">Est. Cost</span><span class="stat-value" id="land-total">0</span></div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    function calculate() {
        const ls = parseFloat(document.getElementById('ls').value) || 0;


        let res = 0; let mainUnit = '$';
        res = ls * 1.5; try { document.getElementById('land-total').innerText = '$'+res.toLocaleString(); } catch(e){}
    ...
    document.getElementById('copy-result').addEventListener('click', function() {
        const text = 'Landscaping Result: ' + document.getElementById('main-result').innerText;
...
</style><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\landscaping-cost-calculator.blade.php ENDPATH**/ ?>