        ...
        <div class="card-body-v2 p-4">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <label class="form-label small fw-bold text-secondary text-uppercase mb-2">Base Length (l)</label>
                    <input type="number" id="in-l" class="form-control form-control-lg rounded-3" value="0" step="any" min="0">
                </div>
                <div class="col-md-6 col-lg-4">
                    <label class="form-label small fw-bold text-secondary text-uppercase mb-2">Base Width (w)</label>
                    <input type="number" id="in-w" class="form-control form-control-lg rounded-3" value="0" step="any" min="0">
                </div>
                <div class="col-md-6 col-lg-4">
                    <label class="form-label small fw-bold text-secondary text-uppercase mb-2">Pyramid Height (h)</label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculate() {
      ...
      const area = (l * w) + l * Math.sqrt(Math.pow(w/2, 2) + Math.pow(h, 2)) + w * Math.sqrt(Math.pow(l/2, 2) + Math.pow(h, 2));
    ...
    btnReset.addEventListener('click', () => {
        ...
        document.getElementById('in-w').value = 0;
    ...
    btnCopyForm.addEventListener('click', function() {
        const formula = `$$A = lw + l\sqrt{\left(\frac{w}{2}\right)^2 + h^2} + w\sqrt{\left(\frac{l}{2}\right)^2 + h^2}$$`;
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\surface-area-of-a-pyramid-calculator.blade.php ENDPATH**/ ?>