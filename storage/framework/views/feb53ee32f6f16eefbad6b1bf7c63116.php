    ...
    <div class="card tool-card-stacked mb-4 shadow-sm border-0">
        ...
        <div class="card-body-v2 p-4">
            ...
            <div class="mt-4 text-center d-flex justify-content-center gap-3 flex-wrap">
                ...
                <a href="/hectares-to-acres" class="btn btn-outline-secondary btn-lg rounded-pill px-4 shadow-sm transition-all ms-2" title="Swap Units"><i class="fas fa-exchange-alt"></i></a>
            </div>
        </div>
    </div>
...
</script><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\acres-to-hectares.blade.php ENDPATH**/ ?>