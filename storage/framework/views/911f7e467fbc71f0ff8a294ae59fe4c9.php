...
<div id="extension-cta" class="extension-cta-toast" style="display: none;">
    ...
    <div class="cta-body">
        ...
        <div class="cta-actions">
            <a href="<?php echo e($chromeUrl); ?>" target="_blank" class="btn btn-extension-primary" id="add-to-chrome-btn">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const threshold = <?php echo e($threshold); ?>;
    const cooldownDays = <?php echo e($cooldown); ?>;
...
<?php endif; ?>
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\components\extension-cta.blade.php ENDPATH**/ ?>