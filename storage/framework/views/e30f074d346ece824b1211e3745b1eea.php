                ...
                <div class="col-md-12">
                    <div class="p-4 rounded-4 h-100" style="background-color: #fff; border: 1.5px solid #f1f5f9;">
                        ...
                        <div class="mt-4 d-flex flex-wrap gap-2">
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="10">10 cm</button>
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="50">50 cm</button>
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="100">100 cm</button>
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="150">150 cm</button>
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="200">200 cm</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4 align-items-center mb-4">
                <div class="col-lg-12 text-center">
                    <div class="p-4 rounded-4 bg-light border">
                        ...
                        <p class="text-muted fw-bold text-uppercase small letter-spacing-1 mb-0">Inches (in)</p>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('btn-copy').addEventListener('click', function() {
        const text = `${inputE.value} cm = ${outResult.textContent} in\\nGenerated via ToolsHub.`;
...
</script><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\cm-to-inches-converter.blade.php ENDPATH**/ ?>