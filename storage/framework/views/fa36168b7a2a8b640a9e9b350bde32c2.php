<div class="interactive-tool-grid asset-allocation-calculator">
    <div class="calculator-card">
        
        <div class="calculator-body">            <div class="form-group-custom mb-3"><label class="form-label-custom">Age</label><input type="number" id="ia" class="form-control-custom" placeholder="e.g. 30"></div>
</div>
    </div>
    <div class="result-panel">
        <div class="result-card-v2">
            ...
            <div class="result-sub-stats">                <div class="stat-item border-end pe-3"><span class="stat-label">Stocks %</span><span class="stat-value" id="stock-val">0</span></div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    function calculate() {
        ...
        res = 110 - ia; mainUnit = '%'; try { document.getElementById('stock-val').innerText = res.toFixed(1)+'%'; } catch(e){}
    ...
    document.getElementById('copy-result').addEventListener('click', function() {
        const text = 'Asset Allocation Result: ' + document.getElementById('main-result').innerText;
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\asset-allocation-calculator.blade.php ENDPATH**/ ?>