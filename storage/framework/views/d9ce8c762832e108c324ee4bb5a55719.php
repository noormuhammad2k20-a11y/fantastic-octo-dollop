<div class="interactive-tool-grid divorce-settlement-calculator">
    <div class="calculator-card">
        <div class="calculator-header">
            <div class="tool-icon-circle" style="background: linear-gradient(135deg, #0ea5e9 0%, #0369a1 100%);"><i class="fas fa-heart-broken"></i></div>
            <div><h4>Divorce Settlement Split</h4><p>Calculate equitable distribution of estates</p></div>
        </div>
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views/tools/interactive/divorce-settlement-calculator.blade.php ENDPATH**/ ?>