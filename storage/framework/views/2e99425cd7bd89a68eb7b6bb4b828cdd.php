...
<section class="seo-section related-tools-section" style="padding-top: 0;">
    ...
    <div class="row g-3">
        ...
        ?>
        <?php $__currentLoopData = $receiptRelated; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relSlug => $relTool): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($relTool): ?>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <a href="<?php echo e(url('/' . $relSlug)); ?>" class="tool-card">
                        ...
                        <div class="tool-body">
                            <h3 class="tool-name"><?php echo e($relTool['h1'] ?? $relTool['name'] ?? ''); ?></h3>
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\create-rent-receipt.blade.php ENDPATH**/ ?>