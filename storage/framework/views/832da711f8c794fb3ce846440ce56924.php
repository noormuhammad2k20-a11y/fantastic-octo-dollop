...
document.addEventListener('DOMContentLoaded',function(){
    ...
    els.btn.addEventListener('click',function(){
        ...
        fetch('<?php echo e(route("ai.generate",["type"=>"real-estate-name"])); ?>',{
            method:'POST',
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\real-estate-business-name-generator.blade.php ENDPATH**/ ?>