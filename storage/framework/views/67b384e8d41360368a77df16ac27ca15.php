...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculate() {
      ...
      document.getElementById('out-area').textContent = area.toFixed(prec);
        ...
        // Apply units
        const outputConfigs = [{"id":"out-vol","label":"Volume (V)","suffixUnit":"cubic units"},{"id":"out-area","label":"Surface Area (A)","suffixUnit":"sq units"}];
    ...
    btnCopyForm.addEventListener('click', function() {
        const formula = `$$V = \\pi r^2 h, A = 2\\pi r h + 2\\pi r^2$$`;
    ...
    btnCopyRes.addEventListener('click', function() {
        const txt = `Volume (V): ${document.getElementById('out-vol').textContent} ${document.getElementById('out-vol-unit').textContent} | Surface Area (A): ${document.getElementById('out-area').textContent} ${document.getElementById('out-area-unit').textContent}`;
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\volume-and-surface-area-calculator.blade.php ENDPATH**/ ?>