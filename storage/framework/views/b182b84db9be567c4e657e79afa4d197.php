        ...
        <div class="calculator-card">
            ...
            <div class="calculator-body">
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <label class="form-label-custom">Items to Arrange (k)</label>
                ...
                <div class="row g-3 mt-2">
                    <div class="col-md-12">
                        <button class="btn d-block mx-auto btn-primary-stats py-3 px-5 fw-bold rounded-pill shadow-sm" id="btn-calculate" style="min-width: 280px; max-width: 100%; background:#ef4444;box-shadow:0 4px 12px rgba(239,68,68,0.2)">
                            <i class="fas fa-play me-2"></i>Calculate P(n, k)
                        </button>
                    </div>
                </div>
            </div>
    ...
    <div class="col-lg-12">
        <div id="results-card" class="output-card-themed" style="--tool-hue:0;--tool-color:#ef4444;--tool-bg:rgba(239,68,68,.04); display: none;">
            <div class="output-hero">
                <span class="output-hero-label">Permutations P(n, k)</span>
                <div class="output-hero-value" id="res-val">720</div>
                <span class="output-hero-unit">Ordered Arrangements</span>
            </div>
            ...
            <div class="step-container mt-5">
                ...
                <div class="step-card mb-3">
                    <div class="step-header">Permutation Formula</div>
                    <div class="step-body">
                        <div class="formula-block text-center py-3">
                            <span class="fs-4">P(n, k) = n! / (n - k)!</span><br>
                            <span class="fs-5 mt-2 d-inline-block" id="step-formula">P(10, 3) = 10! / 7! = 720</span>
                        </div>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculate() {
        ...
        try {
            ...
            $('res-val').textContent = permutations.toLocaleString();
            $('step-formula').textContent = `P(${n}, ${k}) = ${n}! / (${n-k})! = ${permutations}`;
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\permutation-calculator.blade.php ENDPATH**/ ?>