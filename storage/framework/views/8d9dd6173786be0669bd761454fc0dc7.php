                ...
                <?php $__currentLoopData = $planets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-12 col-md-6 col-lg-3">
                        <label class="form-label fw-bold small text-muted text-uppercase letter-spacing-1">
                            <i class="fas <?php echo e($planet['icon']); ?> text-accent me-1"></i> <?php echo e($planet['name']); ?>

                        </label>
                        <select id="sign-<?php echo e($planet['id']); ?>" class="form-select border-0 bg-light rounded-3 shadow-sm py-2">
                            <?php $__currentLoopData = $signs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($sign); ?>"><?php echo e(ucfirst($sign)); ?></option>
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\modality-balance-calculator.blade.php ENDPATH**/ ?>