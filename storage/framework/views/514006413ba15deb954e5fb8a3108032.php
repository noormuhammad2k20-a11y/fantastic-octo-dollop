    ...
    <div class="col-lg-8">
        <div class="calculator-card h-100">
            ...
            <div class="mb-4">
                ...
                <div class="form-text mt-3 opacity-75">Paste the link of the video you want to save.</div>
            </div>

            <button id="convertBtn" class="btn d-block mx-auto -accent mt-4 fs-5 py-3 px-5 fw-bold rounded-pill shadow-sm">
                <i class="fas fa-file-download me-2"></i> Convert to MP4 Now
            </button>
        </div>
    </div>
    ...
    <div class="col-lg-4">
        <div class="calculator-card h-100">
            ...
            <div id="emptyResults" class="text-center py-5">
                ...
                <p class="text-muted small">Your converted video will appear here.</p>
            </div>
            ...
            <div id="resultsArea" class="d-none">
                ...
                <a id="downloadLink" href="#" class="btn-accent w-100 py-3 fw-bold text-white text-decoration-none d-block shadow-sm text-center" download style="border-radius: var(--radius-md);">
                    <i class="fas fa-download me-2"></i> Download MP4 Video
                </a>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    convertBtn.addEventListener('click', async function() {
        ...
        try {
            const response = await fetch('<?php echo e(route("tool.process", ["tool" => "youtube-to-mp4"])); ?>', {
                method: 'POST',
                headers: {
            ...
            if (data.success && data.results && data.results[0].success) {
                ...
                alert(data.message || 'Failed to convert video');
            }
        } catch (error) {
    ...
    // Optional: Auto-select and copy logic if needed, but for files download is key.
});
</script>
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\youtube-to-mp4.blade.php ENDPATH**/ ?>