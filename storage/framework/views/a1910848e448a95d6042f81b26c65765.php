...
<div class="mt-5">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-3">
            <a href="<?php echo e(url($r[0])); ?>" class="d-flex align-items-center p-3 bg-white border rounded-3 text-decoration-none text-dark hover-shadow transition-all">
                <div class="me-3 p-2 rounded-3 bg-light text-primary"><i class="<?php echo e($r[1]); ?>"></i></div>
                <div class="fw-bold small"><?php echo e($r[2]); ?></div>
            </a>
        </div>
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\salary-tax-calculator-pakistan.blade.php ENDPATH**/ ?>