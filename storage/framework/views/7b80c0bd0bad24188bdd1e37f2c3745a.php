<div class="interactive-tool-grid injection-molding-cost-calculator">
    <div class="calculator-card">
        <div class="calculator-header">
            <div class="tool-icon-circle"><i class="fas fa-object-ungroup"></i></div>
            <div><h4>Injection Molding Calculator</h4><p>Accurate Estimation Tool</p></div>
        </div>
        <div class="calculator-body">            <div class="form-group-custom mb-3"><label class="form-label-custom">Quantity</label><input type="number" id="pq" class="form-control-custom" placeholder="e.g. 5000"></div>
</div>
    </div>
    <div class="result-panel">
        <div class="result-card-v2">
            ...
            <div class="result-sub-stats">                <div class="stat-item border-end pe-3"><span class="stat-label">Total Cost</span><span class="stat-value" id="inj-total">0</span></div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    function calculate() {
        const pq = parseFloat(document.getElementById('pq').value) || 0;


        let res = 0; let mainUnit = '$';
        res = pq * 0.5 + 10000; try { document.getElementById('inj-total').innerText = '$'+res.toLocaleString(); } catch(e){}
    ...
    document.getElementById('copy-result').addEventListener('click', function() {
        const text = 'Injection Molding Result: ' + document.getElementById('main-result').innerText;
...
</style><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\injection-molding-cost-calculator.blade.php ENDPATH**/ ?>