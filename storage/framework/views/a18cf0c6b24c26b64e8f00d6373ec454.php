        ...
        <div class="card-body-v2 p-4">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <label class="form-label small fw-bold text-secondary text-uppercase mb-2">Major Radius (R)</label>
                    <input type="number" id="in-R" class="form-control form-control-lg rounded-3" value="0" step="any" min="0">
                </div>
                <div class="col-md-6 col-lg-4">
                    <label class="form-label small fw-bold text-secondary text-uppercase mb-2">Minor Radius (r)</label>
                    <input type="number" id="in-r" class="form-control form-control-lg rounded-3" value="0" step="any" min="0">
                </div>
                <div class="col-md-6 col-lg-4">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculate() {
      ...
      const r = parseFloat(document.getElementById('in-r').value);
      if(isNaN(R) || isNaN(r) || R < 0 || r < 0) return;
      const vol = 2 * Math.pow(Math.PI, 2) * R * r * r;
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\volume-of-a-torus-calculator.blade.php ENDPATH**/ ?>