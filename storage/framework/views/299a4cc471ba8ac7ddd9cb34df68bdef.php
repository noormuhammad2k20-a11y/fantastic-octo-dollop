    ...
    <div class="card tool-card-stacked mb-4 shadow-sm border-0">
        ...
        <div class="card-body-v2 p-4">
            ...
            <div class="mt-4 d-flex flex-wrap justify-content-center gap-3">
                ...
                <a href="/square-feet-to-acres-converter" class="btn btn-outline-secondary btn-lg rounded-pill px-4 shadow-sm transition-all" title="Swap Units"><i class="fas fa-exchange-alt"></i></a>
            </div>
        </div>
    </div>
            ...
            <div class="row g-4 align-items-center mb-4">
                <div class="col-lg-12 text-center">
                    <div class="p-4 rounded-4 bg-light border">
                        ...
                        <p class="text-muted fw-bold text-uppercase small letter-spacing-1 mb-0">Square Feet (sq ft)</p>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculate() {
        ...
        setTimeout(() => {
            ...
            let formulaLatex = "\\text{Square Feet} = \\text{Acres} \\times 43560";
            let stepLatex = "\\text{Square Feet} = {val} \\times 43560 = {res}\\text{ sq ft}".replace('{val}', formattedVal).replace('{res}', formattedRes);
    ...
    btnCopy.addEventListener('click', function() {
        const text = `${inputE.value} ac = ${outResult.textContent} sq ft\nGenerated via ToolsHub.`;
...
</script><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\acres-to-square-feet-converter.blade.php ENDPATH**/ ?>