<div class="interactive-tool-grid cloud-cost-calculator">
    <div class="calculator-card">
        <div class="calculator-header">
            <div class="tool-icon-circle"><i class="fas fa-cloud"></i></div>
            <div><h4>Cloud Cost Calculator</h4><p>Accurate Estimation Tool</p></div>
        </div>
        <div class="calculator-body">            <div class="form-group-custom mb-3"><label class="form-label-custom">VMs</label><input type="number" id="vms" class="form-control-custom" placeholder="e.g. 5"></div>
            <div class="form-group-custom mb-3"><label class="form-label-custom">RAM/VM (GB)</label><input type="number" id="ram" class="form-control-custom" placeholder="e.g. 8"></div>
</div>
    </div>
    <div class="result-panel">
        <div class="result-card-v2">
            ...
            <div class="result-sub-stats">                <div class="stat-item border-end pe-3"><span class="stat-label">Monthly Infra</span><span class="stat-value" id="infra-total">0</span></div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    function calculate() {
        const vms = parseFloat(document.getElementById('vms').value) || 0;
        const ram = parseFloat(document.getElementById('ram').value) || 0;


        let res = 0; let mainUnit = '$';
        res = vms * ram * 5; try { document.getElementById('infra-total').innerText = '$'+res.toLocaleString(); } catch(e){}
    ...
    document.getElementById('copy-result').addEventListener('click', function() {
        const text = 'Cloud Cost Result: ' + document.getElementById('main-result').innerText;
...
</style><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\cloud-cost-calculator.blade.php ENDPATH**/ ?>