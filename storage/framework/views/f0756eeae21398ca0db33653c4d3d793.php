...
document.addEventListener('DOMContentLoaded', function() {
    ...
    btnGenerate.addEventListener('click', function() {
        ...
        fetch('<?php echo e(route("ai.generate", ["type" => "affirmations"])); ?>', {
            method: 'POST',
            headers: {
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\affirmations-generator.blade.php ENDPATH**/ ?>