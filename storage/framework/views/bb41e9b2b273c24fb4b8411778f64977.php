    ...
    <div class="col-lg-8">
        <div class="calculator-card h-100">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-6">
                    <input type="number" id="targetFileSize" class="form-control border-0 shadow-sm py-2" placeholder="Value (e.g., 100)" style="border-radius: var(--radius-md);" value="<?php echo e($prefillVal); ?>">
                </div>
                <div class="col-md-6">
                    <select id="targetFileSizeUnit" class="form-select border-0 shadow-sm py-2" style="border-radius: var(--radius-md);">
                        <option value="kb" <?php echo e($prefillUnit === 'kb' ? 'selected' : ''); ?>>KB</option>
                        <option value="mb" <?php echo e($prefillUnit === 'mb' ? 'selected' : ''); ?>>MB</option>
                    </select>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    convertBtn.addEventListener('click', async function() {
        ...
        try {
            const response = await fetch('<?php echo e(route("tool.process", ["tool" => "hd-image-converter"])); ?>', {
                method: 'POST',
                headers: {
            ...
            if (data.success && data.processed_filename) {
                ...
                const previewUrl = '<?php echo e(route("tool.preview", ["filename" => ":filename"])); ?>'.replace(':filename', data.processed_filename);
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\hd-image-converter.blade.php ENDPATH**/ ?>