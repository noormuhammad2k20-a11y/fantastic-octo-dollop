<div class="interactive-tool-grid dental-implant-cost-calculator">
    <div class="calculator-card">
        <div class="calculator-header">
            <div class="tool-icon-circle"><i class="fas fa-tooth"></i></div>
            <div><h4>Dental Implant Cost Calculator</h4><p>Accurate Estimation Tool</p></div>
        </div>
        <div class="calculator-body">            <div class="form-group-custom mb-3"><label class="form-label-custom">Quantity</label><input type="number" id="qty" class="form-control-custom" placeholder="e.g. 1"></div>
            <div class="form-group-custom mb-3"><label class="form-label-custom">Location</label><select id="loc" class="form-select-custom">                        <option value="metro">Metropolitan</option>
    ...
    <div class="result-panel">
        <div class="result-card-v2">
            ...
            <div class="result-sub-stats">                <div class="stat-item border-end pe-3"><span class="stat-label">Total Cost</span><span class="stat-value" id="total-cost">0</span></div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    function calculate() {
        ...
        res = qty * (loc === 'metro' ? 4000 : 2500); try { document.getElementById('total-cost').innerText = '$'+res.toLocaleString(); } catch(e){}
    ...
    document.getElementById('copy-result').addEventListener('click', function() {
        const text = 'Dental Implant Cost Result: ' + document.getElementById('main-result').innerText;
...
</style><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\dental-implant-cost-calculator.blade.php ENDPATH**/ ?>