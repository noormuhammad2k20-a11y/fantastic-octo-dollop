...
btn.addEventListener('click',function(){
    ...
    fetch('<?php echo e(route("ai.generate",["type"=>"sales-script"])); ?>',{method:'POST',headers:{'Content-Type':'application/json','X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>'},body:JSON.stringify({product:product.value,scriptType:scriptType.value})})
...
</script><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\sales-script-generator.blade.php ENDPATH**/ ?>