<div class="interactive-tool-grid commercial-lease-calculator">
    <div class="calculator-card">
        <div class="calculator-header">
            <div class="tool-icon-circle"><i class="fas fa-store"></i></div>
            <div><h4>Commercial Lease Calculator</h4><p>Accurate Estimation Tool</p></div>
        </div>
        <div class="calculator-body">            <div class="form-group-custom mb-3"><label class="form-label-custom">Area (SQFT)</label><input type="number" id="sq" class="form-control-custom" placeholder="e.g. 2000"></div>
            <div class="form-group-custom mb-3"><label class="form-label-custom">Rate ($)</label><input type="number" id="rt" class="form-control-custom" placeholder="e.g. 25"></div>
</div>
    </div>
    <div class="result-panel">
        <div class="result-card-v2">
            ...
            <div class="result-sub-stats">                <div class="stat-item border-end pe-3"><span class="stat-label">Annual Rent</span><span class="stat-value" id="lease-total">0</span></div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    function calculate() {
        ...
        const rt = parseFloat(document.getElementById('rt').value) || 0;


        let res = 0; let mainUnit = '$';
        res = sq * rt; try { document.getElementById('lease-total').innerText = '$'+res.toLocaleString(); } catch(e){}
    ...
    document.getElementById('copy-result').addEventListener('click', function() {
        const text = 'Commercial Lease Result: ' + document.getElementById('main-result').innerText;
...
</style><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\commercial-lease-calculator.blade.php ENDPATH**/ ?>