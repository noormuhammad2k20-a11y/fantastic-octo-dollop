...
btn.addEventListener('click',function(){
    ...
    fetch('<?php echo e(route("ai.generate",["type"=>"ai-script"])); ?>',{method:'POST',headers:{'Content-Type':'application/json','X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>'},body:JSON.stringify({topic:topic.value,format:format.value,duration:duration.value})})
...
</script><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\ai-script-generator.blade.php ENDPATH**/ ?>