            ...
            <div class="calculator-body">
                ...
                <div class="options-grid p-4 rounded-4" style="background:#f8fafc; border:1px solid #e2e8f0;">
                    <div class="row g-4 align-items-center">
                        <div class="col-md-4">
                            <label class="form-label-custom">Sort Direction</label>
                            <select id="sort-dir" class="form-select">
                                <option value="asc" selected>A to Z (Ascending)</option>
                        ...
                        <div class="col-md-4">
                            <button class="btn btn-primary btn-lg w-100 rounded-pill shadow-sm transition-all" id="btn-sort" style="min-width: 280px; max-width: 100%;">
                                <i class="fas fa-sort me-2"></i> Sort Lines
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class="output-card-themed" style="--tool-hue:240;--tool-color:#4f46e5;--tool-bg:rgba(79,70,229,0.04);">
            <div class="output-header d-flex justify-content-between align-items-center mb-3">
                <div class="d-flex align-items-center">
                    <i class="fas fa-list-ul fs-4 me-2" style="color:#4f46e5"></i>
                    <h6 class="fw-bold mb-0">Sorted Result</h6>
                </div>
            ...
            <div class="mt-3 p-3 bg-white rounded-3 border d-flex justify-content-between align-items-center small text-secondary">
                ...
                <div class="badge bg-light text-primary border" id="mode-badge">Case Sensitive: Off</div>
            </div>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function performSort() {
        ...
        setTimeout(() => {
            ...
            output.value = result;
            statsText.innerHTML = `<i class="fas fa-check-circle text-success me-1"></i> Sorted <strong>${lines.length}</strong> lines successfully.`;
            
            btnSort.innerHTML = '<i class="fas fa-sort me-2"></i> Sort Lines';
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\sort-lines-alpha.blade.php ENDPATH**/ ?>