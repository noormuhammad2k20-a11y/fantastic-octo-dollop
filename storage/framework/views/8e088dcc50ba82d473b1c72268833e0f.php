            ...
            <div class="welcome-card p-5 border-0 shadow-lg rounded-20 bg-white">
                ...
                <div class="cta-box p-4 bg-light rounded-16 border">
                    ...
                    <div class="d-flex gap-3 justify-content-center">
                        <a href="<?php echo e(url('/')); ?>" class="btn btn-primary px-4 py-3 fw-bold">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\welcome-extension.blade.php ENDPATH**/ ?>