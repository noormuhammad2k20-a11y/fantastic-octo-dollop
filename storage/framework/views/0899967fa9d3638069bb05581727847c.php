    ...
    <div class="card tool-card-stacked mb-4 shadow-sm border-0">
        ...
        <div class="card-body-v2 p-4">
            ...
            <div class="mt-4 text-center d-flex justify-content-center gap-3 flex-wrap">
                ...
                <a href="/feet-inches-to-cm" class="btn btn-outline-secondary btn-lg rounded-pill px-4 shadow-sm transition-all ms-2" title="Swap Units">
            ...
            <div class="row g-4 align-items-center mb-4">
                <div class="col-lg-12 text-center">
                    <div class="p-4 rounded-4 bg-light border">
                        <div class="display-4 fw-bold text-primary mb-2" id="out-result">5' 6.93"</div>
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\cm-to-feet-inches.blade.php ENDPATH**/ ?>