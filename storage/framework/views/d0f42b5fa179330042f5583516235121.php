...
<div class="media-rebuilt-container" style="--media-accent: <?php echo e($accentColor); ?>; --media-accent-h: <?php echo e($accentHue); ?>;">
    
    
    <div class="media-card input-card shadow-sm" id="media-input-card">
        <div class="media-header">
            <div class="media-icon-circle">
                <i class="<?php echo e($tool['icon'] ?? 'fas fa-file-video'); ?>"></i>
            </div>
            <div>
                <h4><?php echo e($tool['h1'] ?? $tool['title']); ?></h4>
                <p><?php echo e($tool['description'] ?? $tool['subtitle']); ?></p>
            </div>
        </div>
        ...
        <div class="media-drop-zone mb-4" id="media-drop-zone">
            ...
            <h5 class="fw-bold">Drag & Drop Your <?php echo e(strtoupper($mediaType)); ?> Here</h5>
        ...
        <input type="file" id="media-file-input" accept="<?php echo e($tool['accepted_types'] ?? '*'); ?>" hidden>
                ...
                <div class="pro-options-grid">
                    <?php $__currentLoopData = $tool['options']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="option-group">
                            <label><?php echo e($option['label'] ?? $option['name']); ?></label>
                            <?php if($option['type'] === 'select'): ?>
                                <select class="media-select" name="<?php echo e($option['name']); ?>" id="opt-<?php echo e($option['name']); ?>">
                            ...
                            <?php elseif($option['type'] === 'number'): ?>
                                <input type="number" class="media-input" id="opt-<?php echo e($option['name']); ?>" value="<?php echo e($option['default'] ?? ''); ?>">
                            <?php endif; ?>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<script src="<?php echo e(asset('js/media-engine.js')); ?>"></script>
<script>
document.addEventListener('DOMContentLoaded', () => {
    window.mediaEngine = new MediaEngine({
        slug: '<?php echo e($tool['slug']); ?>',
        processUrl: "<?php echo e(route('tool.process', $tool['slug'])); ?>",
        acceptedTypes: <?php echo json_encode(explode(',', $tool['accepted_types'] ?? '')); ?>,
        maxSizeMB: <?php echo e($tool['max_size_mb'] ?? 500); ?>,
        mediaType: '<?php echo e($mediaType); ?>'
    });
});
</script>
<?php $__env->stopPush(); ?>
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\partials\media_tool_rebuilt.blade.php ENDPATH**/ ?>