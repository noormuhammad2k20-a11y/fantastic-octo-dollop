    ...
    <div class="card tool-card-stacked mb-4 shadow-sm border-0">
        ...
        <div class="card-body-v2 p-4">
                ...
                <div class="col-md-12">
                    <div class="p-4 rounded-4 h-100" style="background-color: #fff; border: 1.5px solid #f1f5f9;">
                        ...
                        <div class="row g-3 align-items-end">
                            <div class="col-md-6">
                                <label class="form-label small fw-bold text-secondary text-uppercase mb-2">Kilometers (km)</label>
                        ...
                        <div class="mt-4 d-flex flex-wrap gap-2">
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="1">1 km</button>
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="5">5 km</button>
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="10">10 km</button>
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="50">50 km</button>
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="100">100 km</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-4 d-flex flex-wrap justify-content-center gap-3">
                ...
                <a href="/miles-to-km-converter" class="btn btn-outline-secondary btn-lg rounded-pill px-4 shadow-sm transition-all" title="Swap Units"><i class="fas fa-exchange-alt"></i></a>
            </div>
        </div>
    </div>
            ...
            <div class="row g-4 align-items-center">
                <div class="col-lg-12 text-center">
                    <div class="p-4 rounded-4 bg-light border">
                        ...
                        <p class="text-muted fw-bold text-uppercase small letter-spacing-1 mb-0">Miles (mi)</p>
                    </div>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculate() {
        ...
        setTimeout(() => {
            let res = (function(val) { return (val * 0.6213711922); })(val);
    ...
    btnCopy.addEventListener('click', function() {
        const text = `${inputE.value} km = ${outResult.textContent} mi\nGenerated via ToolsHub.`;
...
</script><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\km-to-miles-converter.blade.php ENDPATH**/ ?>