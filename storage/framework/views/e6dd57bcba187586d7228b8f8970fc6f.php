        ...
        <div class="calculator-card">
            <div class="calculator-header d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-2">
                    <div class="tool-icon-circle" style="background:rgba(234,88,12,.05);color:#ea580c"><i class="fas fa-trowel-bricks"></i></div>
                    <h5 class="mb-0 fw-bold">Brick and Mortar Calculator</h5>
                </div>
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    function renderFormula() {
        if (typeof katex !== 'undefined') {
            katex.render("N = \\frac{A_{wall}}{A_{brick} + A_{joint}} \\times (1 + W)", $('latex-formula'), {throwOnError: false, displayMode: true});
    ...
    renderFormula();
        ...
        let n = Math.ceil((l*h)/0.13 * (1+wast/100));
        $('res-main').textContent = n.toLocaleString();
        $('res-unit').textContent = 'Bricks';
        $('res-details').innerHTML = `<div class="stat-box"><div class="small text-muted">Mortar</div><div class="fw-bold">${Math.ceil(n/100)} Bags</div></div>`;
    }
...
</style><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\brick-and-mortar-calculator.blade.php ENDPATH**/ ?>