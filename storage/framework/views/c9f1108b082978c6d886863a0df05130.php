<div class="interactive-tool-grid freight-cost-calculator">
    <div class="calculator-card">
        <div class="calculator-header">
            <div class="tool-icon-circle"><i class="fas fa-truck"></i></div>
            <div><h4>Freight Cost Calculator</h4><p>Accurate Estimation Tool</p></div>
        </div>
        <div class="calculator-body">            <div class="form-group-custom mb-3"><label class="form-label-custom">Weight (lbs)</label><input type="number" id="w" class="form-control-custom" placeholder="e.g. 2000"></div>
            <div class="form-group-custom mb-3"><label class="form-label-custom">Distance (mi)</label><input type="number" id="d" class="form-control-custom" placeholder="e.g. 500"></div>
</div>
    </div>
    <div class="result-panel">
        <div class="result-card-v2">
            ...
            <div class="result-sub-stats">                <div class="stat-item border-end pe-3"><span class="stat-label">Quote</span><span class="stat-value" id="fr-total">0</span></div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    function calculate() {
        ...
        res = (w * 0.1) + (d * 1.5); try { document.getElementById('fr-total').innerText = '$'+res.toLocaleString(); } catch(e){}
    ...
    document.getElementById('copy-result').addEventListener('click', function() {
        const text = 'Freight Cost Result: ' + document.getElementById('main-result').innerText;
...
</style><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\freight-cost-calculator.blade.php ENDPATH**/ ?>