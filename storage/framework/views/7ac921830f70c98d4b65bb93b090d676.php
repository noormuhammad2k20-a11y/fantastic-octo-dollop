        ...
        <div class="card-body-v2 p-4">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <label class="form-label small fw-bold text-secondary text-uppercase mb-2">Side Length (a)</label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculate() {
      ...
      const area = (1/4) * Math.sqrt(5 * (5 + 2 * Math.sqrt(5))) * a * a;
    ...
    btnCopyForm.addEventListener('click', function() {
        const formula = `$$A = \frac{1}{4} \sqrt{5(5+2\sqrt{5})} a^2$$`;
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\area-of-a-pentagon-calculator.blade.php ENDPATH**/ ?>