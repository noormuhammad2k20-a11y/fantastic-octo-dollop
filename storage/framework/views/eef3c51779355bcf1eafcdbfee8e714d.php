<div class="interactive-tool-grid data-breach-cost-calculator">
    <div class="calculator-card">
        <div class="calculator-header">
            <div class="tool-icon-circle"><i class="fas fa-user-secret"></i></div>
            <div><h4>Data Breach Cost Calculator</h4><p>Accurate Estimation Tool</p></div>
        </div>
        <div class="calculator-body">            <div class="form-group-custom mb-3"><label class="form-label-custom">Records Lost</label><input type="number" id="recs" class="form-control-custom" placeholder="e.g. 5000"></div>
            <div class="form-group-custom mb-3"><label class="form-label-custom">Industry</label><select id="ind" class="form-select-custom">                        <option value="hc">Healthcare</option>
    ...
    <div class="result-panel">
        <div class="result-card-v2">
            ...
            <div class="result-sub-stats">                <div class="stat-item border-end pe-3"><span class="stat-label">Total Cost</span><span class="stat-value" id="breach-total">0</span></div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    function calculate() {
        const recs = parseFloat(document.getElementById('recs').value) || 0;
        const ind = document.getElementById('ind').value;


        let res = 0; let mainUnit = '$';
        res = recs * (ind === 'hc' ? 408 : (ind === 'fin' ? 200 : 150)); try { document.getElementById('breach-total').innerText = '$'+res.toLocaleString(); } catch(e){}
    ...
    document.getElementById('copy-result').addEventListener('click', function() {
        const text = 'Data Breach Cost Result: ' + document.getElementById('main-result').innerText;
...
</style><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\data-breach-cost-calculator.blade.php ENDPATH**/ ?>