    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="tool-header-card">
                ...
                <div class="fw-bold fs-2 text-dark mb-3">robots.txt Extractor</div>
                <p class="text-muted fs-5 mb-0">Use our premium tool completely free. No signup required.</p>
            </div>

            <!-- Main Interactive Component -->
            <div class="card border-0 shadow-sm rounded-4 mb-5">
                <div class="card-body p-4 p-md-5">                    <form id="toolForm" action="<?php echo e(url('/api/process/' . $tool['slug'])); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-4">
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\robots-txt-extractor.blade.php ENDPATH**/ ?>