<div class="row g-4 css-compressor-rebuilt">
    ...
    <div class="col-lg-12">
        <div class="calculator-card">
            ...
            <div class="calculator-body">
                ...
                <div class="mb-4">
                    <label class="form-label-custom">Raw CSS Code</label>
                    <textarea id="css-input" class="form-control rounded-3 font-monospace small bg-light" rows="10" placeholder="body {&#10;    background-color: #ffffff;&#10;    color: #333333;&#10;    margin: 0px;&#10;}&#10;&#10;/* Navigation */&#10;.nav {&#10;    padding: 10px 20px;&#10;}"></textarea>
                </div>

                <div class="mt-4 d-flex gap-2">
                    <button class="btn btn-primary flex-grow-1 py-3 fw-bold rounded-pill" id="action-compress" style="background-color: #3b82f6; border-color: #3b82f6;"><i class="fas fa-magic me-2"></i>Compress CSS</button>
    ...
    <div class="col-lg-12">
        <div class="output-card-themed" id="output-container" style="--tool-hue:217;--tool-color:#3b82f6;--tool-bg:rgba(59,130,246,.04); display: none;">
            ...
            <h6 class="fw-bold mb-3"><i class="fas fa-code me-2" style="color: var(--tool-color);"></i>Minified CSS</h6>
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    $('action-compress').addEventListener('click', function() {
        ...
        if(!css.trim()) {
            alert('Please enter some CSS code to compress.');
            return;
        }
        ...
        const compSize = new Blob([css]).size;
        let savings = 0;
        if(origSize > 0) {
            savings = ((origSize - compSize) / origSize) * 100;
        }
        
        outCode.textContent = css;
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\css-compressor.blade.php ENDPATH**/ ?>