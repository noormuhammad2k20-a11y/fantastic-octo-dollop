<div class="interactive-tool-grid pest-control-cost-calculator">
    <div class="calculator-card">
        <div class="calculator-header">
            <div class="tool-icon-circle"><i class="fas fa-bug-slash"></i></div>
            <div><h4>Pest Control Calculator</h4><p>Accurate Estimation Tool</p></div>
        </div>
        <div class="calculator-body">            <div class="form-group-custom mb-3"><label class="form-label-custom">Area (SQFT)</label><input type="number" id="hs" class="form-control-custom" placeholder="e.g. 2000"></div>
</div>
    </div>
    <div class="result-panel">
        <div class="result-card-v2">
            ...
            <div class="result-sub-stats">                <div class="stat-item border-end pe-3"><span class="stat-label">Est. Cost</span><span class="stat-value" id="pest-total">0</span></div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    function calculate() {
        const hs = parseFloat(document.getElementById('hs').value) || 0;


        let res = 0; let mainUnit = '$';
        res = hs * 0.10; try { document.getElementById('pest-total').innerText = '$'+res.toLocaleString(); } catch(e){}
    ...
    document.getElementById('copy-result').addEventListener('click', function() {
        const text = 'Pest Control Result: ' + document.getElementById('main-result').innerText;
...
</style><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\pest-control-cost-calculator.blade.php ENDPATH**/ ?>