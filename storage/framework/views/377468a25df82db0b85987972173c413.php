<div class="row g-4 base64-encoder-decoder-rebuilt">
    <div class="col-lg-12">
        <div class="calculator-card">
            ...
            <div class="calculator-body">
                ...
                <div class="col-md-12">
                    <label class="form-label-custom">Input Text/Base64</label>
                    <textarea id="inputStr" class="form-control rounded-3" rows="6" placeholder="Enter text or Base64 string..."></textarea>
                </div>
            ...
            <button class="btn btn-sm btn-outline-success rounded-pill px-4 fw-bold" onclick="encodeStr()">Encode Base64</button>
            <button class="btn btn-sm btn-outline-warning rounded-pill px-4 fw-bold" onclick="decodeStr()">Decode Base64</button>
    ...
    <div class="col-lg-12">
        <div class="output-card-themed" id="output-card-themed" style="--tool-hue:210;--tool-color:#2563eb;--tool-bg:rgba(37,99,235,.04);transition:all .4s">
            ...
            <div class="text-start">
                <label class="form-label-custom mb-2">Resulting Value</label>
...
<style>
.base64-encoder-decoder-rebuilt .calculator-card{background:#fff;border:1px solid #e5e7eb;border-radius:20px;padding:2rem;box-shadow:0 4px 24px rgba(0,0,0,.04)}
.base64-encoder-decoder-rebuilt .calculator-header{display:flex;align-items:center;gap:1rem;margin-bottom:2rem}
.base64-encoder-decoder-rebuilt .calculator-title{font-size:1.5rem; color:#1e293b}
.base64-encoder-decoder-rebuilt .calculator-header p{font-size:.9rem;color:#64748b}
.base64-encoder-decoder-rebuilt .tool-icon-circle{width:56px;height:56px;border-radius:14px;display:flex;align-items:center;justify-content:center;font-size:1.4rem;flex-shrink:0}
.base64-encoder-decoder-rebuilt .form-label-custom{font-size:.8rem;font-weight:700;color:#475569;text-transform:uppercase;letter-spacing:.5px;margin-bottom:.4rem;display:block}
...
</style><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\base64-encoder-decoder.blade.php ENDPATH**/ ?>