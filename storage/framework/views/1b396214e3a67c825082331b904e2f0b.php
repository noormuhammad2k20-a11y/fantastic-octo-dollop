    ...
    <div class="card tool-card-stacked mb-4 shadow-sm border-0">
        ...
        <div class="card-body-v2 p-4">
                ...
                <div class="col-md-12">
                    <div class="p-4 rounded-4 h-100" style="background-color: #fff; border: 1.5px solid #f1f5f9;">
                        ...
                        <div class="row g-3 align-items-end">
                            <div class="col-md-6">
                                <label class="form-label small fw-bold text-secondary text-uppercase mb-2">Miles (mi)</label>
                        ...
                        <div class="mt-4 d-flex flex-wrap gap-2">
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="1">1 mi</button>
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="5">5 mi</button>
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="10">10 mi</button>
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="50">50 mi</button>
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="100">100 mi</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-4 d-flex flex-wrap justify-content-center gap-3">
                ...
                <a href="/km-to-miles-converter" class="btn btn-outline-secondary btn-lg rounded-pill px-4 shadow-sm transition-all" title="Swap Units"><i class="fas fa-exchange-alt"></i></a>
            </div>
        </div>
    </div>
            ...
            <div class="row g-4 align-items-center">
                <div class="col-lg-12 text-center">
                    <div class="p-4 rounded-4 bg-light border">
                        ...
                        <p class="text-muted fw-bold text-uppercase small letter-spacing-1 mb-0">Kilometers (km)</p>
                    </div>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculate() {
        ...
        setTimeout(() => {
            let res = (function(val) { return (val * 1.609344); })(val);
    ...
    btnCopy.addEventListener('click', function() {
        const text = `${inputE.value} mi = ${outResult.textContent} km\nGenerated via ToolsHub.`;
...
</script><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\miles-to-km-converter.blade.php ENDPATH**/ ?>