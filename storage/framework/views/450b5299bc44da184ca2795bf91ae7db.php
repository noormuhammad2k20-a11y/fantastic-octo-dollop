...
btn.addEventListener('click',function(){
    ...
    fetch('<?php echo e(route("ai.generate",["type"=>"linkedin-ai"])); ?>',{method:'POST',headers:{'Content-Type':'application/json','X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>'},body:JSON.stringify({contentType:contentType.value,topic:topic.value,tone:tone.value})})
...
</script><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\linkedin-ai-tools.blade.php ENDPATH**/ ?>