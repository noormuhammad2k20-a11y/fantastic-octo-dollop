            ...
            <div class="calculator-body">
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="number" id="in-axis-a" class="form-control form-control-lg rounded-3" value="10" step="any">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label-custom">Semi-minor Axis (b)</label>
                        <input type="number" id="in-axis-b" class="form-control form-control-lg rounded-3" value="5" step="any">
                    </div>
                    <div class="col-md-4">
                ...
                <div class="mt-4 d-flex flex-wrap gap-2">
                    <button type="button" class="btn btn-primary btn-lg rounded-pill px-5 fw-bold shadow-sm" id="btn-calc" style="background:#8b5cf6;border-color:#8b5cf6;"><i class="fas fa-calculator me-2"></i>Calculate</button>
            ...
            <div class="mt-5">
                ...
                <div class="p-4 bg-white rounded-4 border border-light-subtle shadow-sm">
                    <div class="step-item mb-4">
                        ...
                        <div class="step-formula">A = \pi \times a \times b</div>
                    </div>
                    <div class="step-item mb-4">
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    function calculate(){
        const a = parseFloat($('in-axis-a').value);
        const b = parseFloat($('in-axis-b').value);
        ...
        // Steps
        $('step-substitution').textContent = `A = ${PI.toFixed(6)} \\times ${a} \\times ${b}`;
    ...
    $('btn-copy').addEventListener('click', function(){
        const text = `Ellipse Area Calculation\n` +
                     `--------------------------\n` +
                     `Semi-major axis (a): ${$('in-axis-a').value} ${$('in-unit').value}\n` +
                     `Semi-minor axis (b): ${$('in-axis-b').value} ${$('in-unit').value}\n` +
    ...
    ['input', 'change'].forEach(evt => {
        $('in-axis-a').addEventListener(evt, calculate);
        $('in-axis-b').addEventListener(evt, calculate);
...
.geometry-calc-rebuiltStat-card-label{display:block;font-size:.8rem;font-weight:700;color:#64748b;text-transform:uppercase;margin-bottom:.4rem}
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\area-of-an-ellipse-calculator.blade.php ENDPATH**/ ?>