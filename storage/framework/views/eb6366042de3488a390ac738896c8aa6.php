<div class="row g-4 SHA1-rebuilt">
    <div class="col-lg-12">
    ...
    <div class="col-lg-12">
        <div class="output-card-themed" style="--tool-color:#a855f7;--tool-bg:rgba(168,85,247,.04);">
            <div class="output-hero"><span class="output-hero-label">SHA-1 HASH DIGEST</span><div class="output-hero-value" id="hash-result" style="font-size:1rem;font-family:'Courier New',monospace;word-break:break-all;overflow-wrap:break-word;max-width:100%;overflow-x:auto">—</div></div>
            <div class="row g-3 mt-3">
                <div class="col-6 col-md-3"><div class="stat-card"><span class="stat-card-label">ALGORITHM</span><span class="stat-card-value" style="font-size:1rem">SHA-1</span></div></div>
...
document.addEventListener('DOMContentLoaded',function(){
    ...
    async function doHash(d){const r=await crypto.subtle.digest('SHA-1',new TextEncoder().encode(d));return bufToHex(r);}
...
<style>.SHA1-rebuilt .calculator-card{background:#fff;border:1px solid #e5e7eb;border-radius:20px;padding:2rem;box-shadow:0 4px 24px rgba(0,0,0,.04)}.SHA1-rebuilt .calculator-header{display:flex;align-items:center;gap:1.25rem;margin-bottom:2rem}.SHA1-rebuilt .calculator-header h4{margin:0;font-weight:800;color:#1e293b;font-size:1.25rem}.SHA1-rebuilt .calculator-header p{margin:0;font-size:.85rem;color:#64748b}.SHA1-rebuilt .tool-icon-circle{width:56px;height:56px;border-radius:14px;display:flex;align-items:center;justify-content:center;font-size:1.4rem;flex-shrink:0}.SHA1-rebuilt .form-label-custom{font-size:.8rem;font-weight:700;color:#475569;text-transform:uppercase;letter-spacing:.5px;margin-bottom:.4rem;display:block}</style><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\sha1-hash-generator.blade.php ENDPATH**/ ?>