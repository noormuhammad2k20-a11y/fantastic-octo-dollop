<div class="interactive-tool-grid private-jet-charter-cost-calculator">
    <div class="calculator-card">
        <div class="calculator-header">
            <div class="tool-icon-circle"><i class="fas fa-plane"></i></div>
            <div><h4>Private Jet Charter Calculator</h4><p>Accurate Estimation Tool</p></div>
        </div>
        <div class="calculator-body">            <div class="form-group-custom mb-3"><label class="form-label-custom">Flight Hours</label><input type="number" id="fh" class="form-control-custom" placeholder="e.g. 3"></div>
</div>
    </div>
    <div class="result-panel">
        <div class="result-card-v2">
            ...
            <div class="result-sub-stats">                <div class="stat-item border-end pe-3"><span class="stat-label">Charter Cost</span><span class="stat-value" id="char-total">0</span></div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    function calculate() {
        const fh = parseFloat(document.getElementById('fh').value) || 0;


        let res = 0; let mainUnit = '$';
        res = fh * 5000 + 1000; try { document.getElementById('char-total').innerText = '$'+res.toLocaleString(); } catch(e){}
    ...
    document.getElementById('copy-result').addEventListener('click', function() {
        const text = 'Private Jet Charter Result: ' + document.getElementById('main-result').innerText;
...
</style><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\private-jet-charter-cost-calculator.blade.php ENDPATH**/ ?>