                    ...
                    <div class="col-md-12">
                        ...
                        <div class="d-flex flex-wrap gap-2" id="btc-types-grid">
                            <?php $__currentLoopData = ['A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button type="button" class="btn btn-outline-danger flex-grow-1 py-3 fw-bold rounded-3 type-btn <?php echo e($type === 'O+' ? 'active' : ''); ?>" data-type="<?php echo e($type); ?>">
                                    <?php echo e($type); ?>
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\blood-type-compatibility.blade.php ENDPATH**/ ?>