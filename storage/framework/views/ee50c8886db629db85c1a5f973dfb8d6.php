<div class="interactive-tool-grid hvac-installation-cost-calculator">
    <div class="calculator-card">
        <div class="calculator-header">
            <div class="tool-icon-circle"><i class="fas fa-wind"></i></div>
            <div><h4>HVAC Installation Calculator</h4><p>Accurate Estimation Tool</p></div>
        </div>
        <div class="calculator-body">            <div class="form-group-custom mb-3"><label class="form-label-custom">Home SQFT</label><input type="number" id="h-sqft" class="form-control-custom" placeholder="e.g. 2000"></div>
</div>
    </div>
    <div class="result-panel">
        <div class="result-card-v2">
            ...
            <div class="result-sub-stats">                <div class="stat-item border-end pe-3"><span class="stat-label">Est. Cost</span><span class="stat-value" id="hvac-total">0</span></div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    function calculate() {
        const h_sqft = parseFloat(document.getElementById('h-sqft').value) || 0;


        let res = 0; let mainUnit = '$';
        res = h_sqft * 4; try { document.getElementById('hvac-total').innerText = '$'+res.toLocaleString(); } catch(e){}
    ...
    document.getElementById('copy-result').addEventListener('click', function() {
        const text = 'HVAC Installation Result: ' + document.getElementById('main-result').innerText;
...
</style><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\hvac-installation-cost-calculator.blade.php ENDPATH**/ ?>