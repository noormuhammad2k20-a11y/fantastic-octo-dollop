                    ...
                    <div class="col-md-7">
                        <div class="p-4 rounded-4 bg-slate-900 border border-slate-800 h-100">
                            ...
                            <div class="input-group input-group-lg bg-slate-950 rounded-4 overflow-hidden border border-slate-700 shadow-lg">
                                <input type="text" id="w-url" class="form-control border-0 bg-transparent text-emerald-400 fw-bold small" value="https://toolshub.io/webhook/<?php echo e(Str::random(12)); ?>" readonly>
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\webhook-tester-pro.blade.php ENDPATH**/ ?>