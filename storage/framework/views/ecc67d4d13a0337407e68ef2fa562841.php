...
btn.addEventListener('click',function(){
    ...
    fetch('<?php echo e(route("ai.generate",["type"=>"ai-gift"])); ?>',{method:'POST',headers:{'Content-Type':'application/json','X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>'},body:JSON.stringify({recipient:recipient.value,occasion:occasion.value,budget:budget.value})})
...
</script><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\ai-gift-generator.blade.php ENDPATH**/ ?>