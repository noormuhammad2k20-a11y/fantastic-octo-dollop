                    ...
                    <div class="col-md-6">
                        <div class="p-4 rounded-4 bg-light border h-100">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" id="v-start" class="form-control border-0 bg-white shadow-sm rounded-3 fw-bold h5 mb-0" value="<?php echo e(date('Y-m-d')); ?>">
                            </div>
                            <div class="mb-0">
                                <label class="form-label-custom">Target Horizon (End Date)</label>
                                <input type="date" id="v-end" class="form-control border-0 bg-white shadow-sm rounded-3 fw-bold h5 mb-0" value="<?php echo e(date('Y-m-d', strtotime('+30 days'))); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5 border-start">
                        <div class="ps-md-4">
                            ...
                            <div class="p-3 rounded-4 bg-orange-50 border border-orange-100 mb-4">
                                <div class="small fw-bold text-orange-900 lh-base" id="out-advice">Target date: <?php echo e(date('M d, Y', strtotime('+30 days'))); ?></div>
                            </div>
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\date-calculator.blade.php ENDPATH**/ ?>