<div class="interactive-tool-grid relocation-expense-calculator">
    <div class="calculator-card">
        <div class="calculator-header">
            <div class="tool-icon-circle"><i class="fas fa-map-location-dot"></i></div>
            <div><h4>Relocation Expense Calculator</h4><p>Accurate Estimation Tool</p></div>
        </div>
        <div class="calculator-body">            <div class="form-group-custom mb-3"><label class="form-label-custom">Movers ($)</label><input type="number" id="me" class="form-control-custom" placeholder="e.g. 2000"></div>
            <div class="form-group-custom mb-3"><label class="form-label-custom">Fees ($)</label><input type="number" id="mf" class="form-control-custom" placeholder="e.g. 500"></div>
</div>
    </div>
    <div class="result-panel">
        <div class="result-card-v2">
            ...
            <div class="result-sub-stats">                <div class="stat-item border-end pe-3"><span class="stat-label">Total Budget</span><span class="stat-value" id="relo-total">0</span></div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    function calculate() {
        ...
        res = me + mf + 1000; try { document.getElementById('relo-total').innerText = '$'+res.toLocaleString(); } catch(e){}
    ...
    document.getElementById('copy-result').addEventListener('click', function() {
        const text = 'Relocation Expense Result: ' + document.getElementById('main-result').innerText;
...
</style><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\relocation-expense-calculator.blade.php ENDPATH**/ ?>