        ...
        <div class="card-body-v2 p-4">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <label class="form-label small fw-bold text-secondary text-uppercase mb-2">Base 1 (a)</label>
                    <input type="number" id="in-a" class="form-control form-control-lg rounded-3" value="0" step="any" min="0">
                </div>
                <div class="col-md-6 col-lg-4">
                    <label class="form-label small fw-bold text-secondary text-uppercase mb-2">Base 2 (b)</label>
                    <input type="number" id="in-b" class="form-control form-control-lg rounded-3" value="0" step="any" min="0">
                </div>
                <div class="col-md-6 col-lg-4">
                    <label class="form-label small fw-bold text-secondary text-uppercase mb-2">Trapezoid Height (h)</label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculate() {
      ...
      if(isNaN(a) || isNaN(b) || isNaN(h) || isNaN(l) || a < 0 || b < 0 || h < 0 || l < 0) return;
      const vol = ((a + b) / 2) * h * l;
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\volume-of-a-trapezoidal-prism-calculator.blade.php ENDPATH**/ ?>