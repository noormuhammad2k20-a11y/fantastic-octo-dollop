<div class="interactive-tool-grid dividend-income-calculator">
    <div class="calculator-card">
        <div class="calculator-header">
            <div class="tool-icon-circle"><i class="fas fa-money-bill-trend-up"></i></div>
            <div><h4>Dividend Income Calculator</h4><p>Accurate Estimation Tool</p></div>
        </div>
        <div class="calculator-body">            <div class="form-group-custom mb-3"><label class="form-label-custom">Price ($)</label><input type="number" id="sp" class="form-control-custom" placeholder="e.g. 150"></div>
            <div class="form-group-custom mb-3"><label class="form-label-custom">Div/Share ($)</label><input type="number" id="dp" class="form-control-custom" placeholder="e.g. 4"></div>
</div>
    </div>
    <div class="result-panel">
        <div class="result-card-v2">
            ...
            <div class="result-sub-stats">                <div class="stat-item border-end pe-3"><span class="stat-label">Ann. Income</span><span class="stat-value" id="div-total">0</span></div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    function calculate() {
        ...
        res = sp ? dp * (10000 / sp) : 0; try { document.getElementById('div-total').innerText = '$'+res.toLocaleString(); } catch(e){}
    ...
    document.getElementById('copy-result').addEventListener('click', function() {
        const text = 'Dividend Income Result: ' + document.getElementById('main-result').innerText;
...
</style><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\dividend-income-calculator.blade.php ENDPATH**/ ?>