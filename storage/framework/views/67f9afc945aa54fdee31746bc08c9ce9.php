<div class="interactive-wrapper">
    ...
    <div class="card tool-card-stacked mb-4 shadow-sm border-0">
        ...
        <div class="card-body-v2 p-4">
            ...
            <textarea id="input-text" class="form-control tool-textarea mb-4" rows="10" placeholder="Item 1&#10;Item 2&#10;Item 3..."></textarea>
            
            <div class="p-4 rounded-4" style="background-color: #f8f9fa; border: 1px solid #eef0f2;">
                <div class="row g-4 align-items-end">
                    <div class="col-md-4">
                        <label class="form-label small fw-bold text-secondary text-uppercase mb-2">Prefix (Start)</label>
                        <input type="text" id="v-prefix" class="form-control form-control-lg rounded-3" value="<li>" placeholder="e.g. <li>">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label small fw-bold text-secondary text-uppercase mb-2">Suffix (End)</label>
                        <input type="text" id="v-suffix" class="form-control form-control-lg rounded-3" value="</li>" placeholder="e.g. </li>">
                    </div>
                    <div class="col-md-4">
                        <button class="btn btn-primary btn-lg w-100 rounded-pill shadow-sm transition-all" id="btn-process" style="min-width: 280px; max-width: 100%;">
                            <i class="fas fa-magic me-2"></i> Process List
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="text-muted small mb-0" id="stats-text">Processed result ready for use</p>
                    </div>
                </div>
...
<style>
    ...
    .form-control-lg { border: 1.5px solid var(--border-color); border-radius: 12px; font-size: 1rem; }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const prefixInput = document.getElementById('v-prefix');
    const suffixInput = document.getElementById('v-suffix');
    ...
    btnProcess.addEventListener('click', () => {
        ...
        setTimeout(() => {
            ...
            const formatted = lines.map(line => prefix + line + suffix).join('\n');
            
            output.value = formatted;
            statsText.textContent = `Processed ${lines.length} items successfully`;
            
            btnProcess.innerHTML = '<i class="fas fa-magic me-2"></i> Process List';
    ...
    btnClear.addEventListener('click', () => {
        input.value = '';
        output.value = '';
        statsText.textContent = 'Processed result ready for use';
    });
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\add-prefix-suffix.blade.php ENDPATH**/ ?>