                ...
                <div class="col-md-12">
                    <div class="p-4 rounded-4 h-100" style="background-color: #fff; border: 1.5px solid #f1f5f9;">
                        ...
                        <div class="row g-3 align-items-end">
                            <div class="col-md-6">
                                <label class="form-label small fw-bold text-secondary text-uppercase mb-2">Gigabytes (GB)</label>
                        ...
                        <div class="mt-4 d-flex flex-wrap gap-2">
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="100">100 GB</button>
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="500">500 GB</button>
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="1024">1024 GB</button>
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="2048">2048 GB</button>
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3 quick-val" data-val="5000">5000 GB</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4 align-items-center mb-4">
                <div class="col-lg-12 text-center">
                    <div class="p-4 rounded-4 bg-light border">
                        ...
                        <p class="text-muted fw-bold text-uppercase small letter-spacing-1 mb-0">Terabytes (TB)</p>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculate() {
        ...
        setTimeout(() => {
            let res = (function(val) { return (val / 1024); })(val);
            ...
            let formulaLatex = "\\text{Terabytes} = \\frac{\\text{Gigabytes}}{1024}";
            let stepLatex = "\\text{Terabytes} = \\frac<?php echo e(val); ?>{1024} = {res}\\text{ TB}".replace('{val}', formattedVal).replace('{res}', formattedRes);
    ...
    btnCopy.addEventListener('click', function() {
        const text = `${inputE.value} GB = ${outResult.textContent} TB\nGenerated via ToolsHub.`;
...
</script><?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\gb-to-tb-converter.blade.php ENDPATH**/ ?>