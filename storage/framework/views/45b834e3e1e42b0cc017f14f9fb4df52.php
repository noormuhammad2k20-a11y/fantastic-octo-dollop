...
document.addEventListener('DOMContentLoaded', function() {
    ...
    convertBtn.addEventListener('click', async function() {
        ...
        try {
            const response = await fetch('<?php echo e(route("tool.process", ["tool" => "youtube-shorts-downloader"])); ?>', {
                method: 'POST',
                headers: {
...
<?php /**PATH D:\Xamp\htdocs\ToolsHub\resources\views\tools\interactive\youtube-shorts-downloader.blade.php ENDPATH**/ ?>